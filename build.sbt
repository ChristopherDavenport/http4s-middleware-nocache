...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/http4s-middleware-nocache"),
        "git@github.com:ChristopherDavenport/http4s-middleware-nocache.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/http4s-middleware-nocache")),
